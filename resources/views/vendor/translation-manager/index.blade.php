...
<link href="{{ url('') }}/backend/vendors/x-editable/x-editable.css" rel="stylesheet"/>
<style>
    a.status-1{
        font-weight: bold;
    }
...
@push('myJs')
    <script src="{{ url('') }}/backend/vendors/x-editable/x-editable.js"></script>
                ...
                <div class="row clearfix">
                    <div class="col-lg-5 col-md-5 col-sm-12">
                        ...
                        <ul class="breadcrumb padding-0">
                            ...
                            {{--<li class="breadcrumb-item"><a href="{{ route('category.list') }}">Translate</a></li>--}}
